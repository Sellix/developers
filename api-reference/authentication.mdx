...
If you have more than one shop (merchant) under your Sellix account, you can send API requests with their authorization by passing the `X-Sellix-Merchant` header to each request.
