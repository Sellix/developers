...
For orders with a payment method chosen, they are voided within 24 hours.
For orders without a payment method chosen, they are voided within 14 days.

There is a limit on how many pending orders you can have, both for your store and for single customers.
