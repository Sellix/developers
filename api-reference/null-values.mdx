...
In cases where a field is deprecated, our API continues to include the field in all requests as `"null"` in a string format. This approach is maintained for backward compatibility, ensuring that integrations remain functional without disruption.
