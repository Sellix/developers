...
# Comparing Legacy Subscriptions and Subscriptions 2.0

Sellix offers two subscription models — [Legacy Subscriptions](https://docs.sellix.io/api-reference/subscriptions) and [Subscriptions 2.0](https://docs.sellix.io/api-reference/subscriptions-2-0) — each tailored to different merchant needs. While Legacy Subscriptions provide fundamental recurring billing features, Subscriptions 2.0 introduces advanced options to support a broader range of business models.

<Info title="Subscription Models Overview">
Legacy Subscriptions are ideal for straightforward, interval-based billing, whereas Subscriptions 2.0 is a powerful upgrade offering enhanced flexibility, new billing intervals, and webhook support.
</Info>
...
| Feature                        | Legacy Subscriptions                  | Subscriptions 2.0                           |
|--------------------------------|---------------------------------------|--------------------------------------------|
...
<Warning>
Legacy Subscriptions are still supported but lack some of the advanced billing options available in Subscriptions 2.0.
</Warning>
...
<Callout type="success" title="Why Choose Subscriptions 2.0?">
...
<Note>
  Subscriptions 2.0 also includes a billing portal for customers to manage, view, and cancel subscriptions, improving customer experience.
</Note>
...
| Choose **Legacy Subscriptions** if...                               | Choose **Subscriptions 2.0** if...                                 |
|---------------------------------------------------------------------|-------------------------------------------------------------------|
