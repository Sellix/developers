...
| `subscription-v2:started` | Triggered once when product subscription is created (not started yet). |
...
| `subscription-v2:canceled-system` | Triggered when a product subscription is canceled by the system. |
...
| `subscription-v2:plan:canceled-system` | Triggered when a product plan subscription is canceled by the system. |
...
| `subscription-v2:trial-interval:canceled-system` | Triggered when a trial payment interval is canceled by the system. |
...
| `subscription-v2:payment-interval:canceled-system` | Triggered when a payment interval is canceled by the system. |
...
> **Note**: The "canceled" event is common for all types of cancellations and may be triggered by the customer, merchant, developer, or system.
