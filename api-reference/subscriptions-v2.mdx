...
<Step title="Step 2">
  ...
  - **Email**
  - **Product ID**: ID of the subscriptions v2 product
...
### Available Fields
- For a list of available fields, please check the [API Reference](https://docs.sellix.io/api-reference/subscriptions-v2/post-subscriptions).
...
![crypto subs](https://cdn.sellix.io/static/documentation/images/crypto-subscriptions.png)
...
<Note>We also have our legacy subscription model. Please see a [comparison between our legacy subscriptions model and subscriptions v2](https://docs.sellix.io/api-reference/subscriptions-compare)</Note>