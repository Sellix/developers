...
<CardGroup cols={2}>
  <Card title="Get Subscriptions" icon="bars-staggered" href="/api-reference/get-subscription">
    Use our API to get the details of a subscription from one of your customers
  </Card>
  <Card title="Create Subscription" icon="plus" href="/api-reference/create-subscriptions">
