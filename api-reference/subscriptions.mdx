...
<CardGroup cols={2}>
  <Card title="Get Subscriptions" icon="bars-staggered" href="/api-reference/subscriptions-v2/get-subscription">
    Use our API to get the details of a subscription from one of your customers
  </Card>
  <Card title="Create Subscription" icon="plus" href="/api-reference/subscriptions-v2/post-subscriptions">
...
<Card title="Subscription Object" icon="brackets-curly" href="/api-reference/subscriptions-v2/get-subscription">
...
<Card title="Developers API" icon="code" href="/api-reference/subscriptions-v2/post-subscriptions">
