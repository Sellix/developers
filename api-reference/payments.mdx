...
<CardGroup cols={2}>
  <Card title="Complete a Payment" icon="check-to-slot" href="/api-reference/payments/create-payments">
...
<CardGroup cols={2}>
  <Card title="Get Order" icon="dice-one" href="/api-reference/orders/get-orders">
...
![checkout-flow](https://cdn.sellix.io/static/documentation/images/checkout.png)
...
![checkout-flow](https://cdn.sellix.io/static/documentation/images/all-products.png)