...
<Info>This has the added downside of not having the realtime status updates that the integrated checkout flow offers, but this can of course be implemented on your side using the webhooks.</Info>
...
![checkout-flow](/images/all-products.png)